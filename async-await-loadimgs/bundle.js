...
/***/ (function(module, exports, __webpack_require__) {
	...
	var entry = function () {
	    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(imgList, cb) {
	        var rs;
	...
	function loadImgs(imgList) {
	    ...
	    return Promise.all(proList).then(function (rs) {
	        console.log("finish all");
	        return Promise.resolve(rs);
	    });
	}
	
	var imgUrlList = ["http://111.231.236.41/vipstyle/cartoon/v4/release/pic/index/recomment-single-s3.png", "http://111.231.236.41/vipstyle/cartoon/v4/release/pic/index/recomment-single-s2.png"];
